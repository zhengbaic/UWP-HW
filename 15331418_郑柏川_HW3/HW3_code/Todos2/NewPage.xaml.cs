    ...
    public sealed partial class NewPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else
            {
                ...
                img.Source = ViewModel.SelectedItem.image;
            }
        }
        private void CreateButton_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ViewModel.AddTodoItem(title.Text, description.Text, datepicker.Date, (BitmapImage)img.Source);
                    Frame.Navigate(typeof(MainPage), ViewModel);
                }
                else
                {
                    ViewModel.UpdateTodoItem(ViewModel.SelectedItem.getid(), title.Text, description.Text, datepicker.Date, (BitmapImage)img.Source);
                    Frame.Navigate(typeof(MainPage), ViewModel);
                }
