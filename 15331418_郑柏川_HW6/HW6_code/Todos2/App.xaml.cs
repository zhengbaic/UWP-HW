...
namespace Todos2
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnShareTargetActivated(ShareTargetActivatedEventArgs a)
        {
            var rootFrame = new Frame();
            //加载的不一定是MainPage,一般是单独一个页面获取
            rootFrame.Navigate(typeof(MainPage), a.ShareOperation);
            Window.Current.Content = rootFrame;
            Window.Current.Activate();
        }
    }
